...
export class Features {
  constructor(featureData) {
    this.feature = featureData.feature;
  }
  createContentTemplate() {
    const content = `
       <div class="swiper-slide">
          <div class="feature-box">
            <p class="feature-desc">${this.feature}</p>
          </div>
        </div>
    `;
...
export class FAQ {
  constructor(faqData) {
    ...
    this.photo = faqData.photo;
    this.photoAlt = faqData.photoAlt;
  }
  createContentTemplate() {
    const content = `
    <div class="faq-card">
...
export const socialIcons = [
  {
    name: "Twitter",
    href: "https://twitter.com/business_dbs",
    class: "bi bi-twitter",
  ...
  {
    name: "Linkedin",
    href: "https://www.linkedin.com/company/86409242/admin/",
  ...
  {
    name: "Discord",
    href: "https://discord.gg/vcwFt6CY",
    class: "bi bi-discord",
  ...
  {
    name: "Medium",
    href: "https://medium.com/@dbs_ecosystem",
    class: "bi bi-medium",
...
export class Social {
  ...
  createContentTemplate(flagName = false) {
    ...
    <a href="${this.href}" class="soc-icon"
      ><svg
        xmlns="${xmlns}"
        width="${width}"
        height="${height}"
